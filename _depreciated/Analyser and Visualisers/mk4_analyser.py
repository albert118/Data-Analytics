""" Prototype analyser : MK4
mk1 	: take data "objects" and generate overview info on them graphically.
mk2		: extend mk1 to more pythonic systems and add further methods.
mk3		: automate visualisation process for analytics.
MK4     : further integrate existing pandas and numpy systems for data resolution
